...
def draw_screen():
    ...
    # 显示积分
    score_text = font.render(f"积分: {score}/{target_score}", True, (0, 0, 0))
    ...
    button_text = font.render("漂发", True, (0, 0, 0))
    screen.blit(button_text, (180, 130))
    
    # 如果按钮激活，显示提示
    if button_active:
        hint_text = font.render("你可以成为金发!", True, (255, 0, 0))
